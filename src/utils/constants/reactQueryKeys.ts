...
export const MUTATION_KEY_UPLOAD_ACTIVITY_GALLERY_IMAGES = 'uploadActivityGalleryImages' as string;

export const MUTATION_KEY_ADD_VOLUNTEER_TO_ACTIVITY = 'addVolunteerToActivity' as string;
