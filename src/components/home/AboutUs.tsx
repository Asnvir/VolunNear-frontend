...
const AboutUsSection = () => {
  return (
    <Box mx="auto" p={4} maxW="1440px" textAlign="center" color="black">
      ...
      <Flex direction={{ base: 'column', md: 'row' }} justifyContent="space-between" px={8} gap={8}>
        <VStack alignItems="flex-start" spacing={4} width={{ base: '100%', md: '400px' }}>
          <Heading fontFamily="Bevan" fontWeight="700" fontSize={{ base: "20px", md: "24px" }} color="#18171C">
            Our Mission
          </Heading>
          <Text fontFamily="Epilogue" fontWeight="400" fontSize="16px" color="#4F4F4F" textAlign='start'>
