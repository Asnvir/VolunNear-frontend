...
const DescriptionBoxes = () => {
  const volunteerPrinciples = [
    {
      title: 'Commitment',
      description: 'Commit to the cause and show dedication.',
    },
    {title: 'Respect', description: 'Respect the communities you serve.'},
    {
      title: 'Communication',
      description: 'Communicate effectively with team members.',
    },
  ...
  const organizationPrinciples = [
    {
      title: 'Transparency',
      description: 'Collaborate transparently with volunteers.',
    },
    ...
    {
      title: 'Appreciation',
      description: 'Recognize and appreciate volunteer efforts.',
    },
    {
      title: 'Alignment',
      description: 'Align volunteer roles with their skills and interests.',
    },
  ];
  ...
  return (
    <Box mx="auto" p={4} maxW="1440px" bg="white" textAlign="center">
      ...
      />
      <DescriptionBox
        heading="Principles for OrganizationsPage"
